...
<html lang="en">
  <head>
    <title><?php echo $title_web;?> | Rental Peralatan Outdoor</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #333;">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item <?php if($title_web == 'Daftar Barang'){ echo 'active';}?>
                <?php if($title_web == 'Tambah Barang'){ echo 'active';}?>
                <?php if($title_web == 'Edit Barang'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/mobil/barang.php">Daftar Barang</a>
                </li>
