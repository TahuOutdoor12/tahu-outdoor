...
<html lang="en">
  <head>
    <title>Rental Perlengkapan Outdoor</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <form class="form-inline" method="get" action="blog.php">
                    <input class="form-control mr-sm-2" type="search" name="cari" placeholder="Cari Nama Barang" aria-label="Search">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="blog.php">Daftar Nama Barang</a>
                </li>
                <li class="nav-item active">
